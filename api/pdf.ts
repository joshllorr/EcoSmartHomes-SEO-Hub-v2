...
function generateRetrofitPdfHtml(plan: any, user: any): string {
...
<body>
  ...
  <div class="section-card">
    ...
    <table>
      ...
      <tbody>
        <tr><td>Air-to-Water Heat Pump</td><td>€12,500</td><td>Fossil fuel heating replacement / pre-2021 build</td></tr>
        <tr><td>External Wall Insulation</td><td>€8,000</td><td>Year built prior to 2011; solid walls</td></tr>
        <tr><td>Standalone High-Efficiency Windows</td><td>€4,000</td><td>High-performance double/triple glazing</td></tr>
        <tr><td>High-Performance External Doors</td><td>€800 / door</td><td>Up to 2 doors (€1,600 max)</td></tr>
        <tr><td>Attic Insulation Upgrade</td><td>€2,000</td><td>Attic insulation under 300mm (€2,500 FTB/Welfare)</td></tr>
        <tr><td>Cavity Wall Insulation</td><td>€1,800</td><td>Cavity block walls (€2,300 Welfare)</td></tr>
        <tr><td>Solar PV Panels</td><td>€1,800</td><td>Rooftop solar PV installation</td></tr>
        <tr><td>Smart Heating Controls</td><td>€700</td><td>Multi-zone programmer / thermostats</td></tr>
      </tbody>
    </table>
  </div>
  ...
  <div class="section-card">
    <div class="section-title">6. Mandatory 2026 Compliance Documents & SEAI Surveyor</div>
    <ul style="font-size: 12px; color: #334155; margin: 0 0 10px 0; padding-left: 20px;">
      ...
      <li>New Format BER Assessment Certificate (A0–G)</li>
