# Complete Home Energy Survey & Retrofit Guide: SEAI Technical Advisor Fee Repayment Fermoy

Welcome to the **EcoSmartHomes Ireland** regional advisory portal for Fermoy and the wider Blackwater Valley area. If you are planning to upgrade your property's energy efficiency, decarbonise your heating system, or apply for an SEAI Heat Pump Grant, securing an independent technical assessment is your mandatory first step.

This guide outlines the local housing stock characteristics of Fermoy, breaks down the **SEAI technical advisor fee repayment** mechanism, and details the fabric-first roadmap required to lift your home to an A2 Building Energy Rating (BER) in compliance with **Technical Guidance Document (TGD) Part L (Conservation of Fuel and Energy – Dwellings)**.
...
```
+----------------------------------------------------------------------------------------------------+
|                               FERMOY HOUSING STOCK & FABRIC PROFILES                                |
+-------------------------------+----------------------------------+---------------------------------+
| Architectural Era             | Typical Wall / Floor Fabric      | Critical Thermal Deficiencies   |
+-------------------------------+----------------------------------+---------------------------------+
| Pre-1940: Town Centre &       | Solid rubble stone / mass        | Extreme conductive heat loss;   |
| Riverfront (e.g., MacCurtain  | concrete; suspended uninsulated  | rising damp; uninsulated attics;|
| St, Barrack Hill)             | timber ground floors             | open chimney draft paths.       |
+-------------------------------+----------------------------------+---------------------------------+
| 1960s–1980s: Established      | 275mm–300mm uninsulated cavity   | Degraded aerated wall ties;     |
| Estates (e.g., Uplands,       | brick/block or hollow block;     | single/early double glazing;    |
| St. Patrick’s, Richmond)      | uninsulated concrete subfloors   | unlagged cold-roof attic voids. |
+-------------------------------+----------------------------------+---------------------------------+
| 1990s–mid 2000s: Suburban &   | Partially insulated cavity;      | Substandard continuous EPS;     |
| Rural Builds (e.g., Dun Eala, | 50mm–100mm ground floor slab EPS;| uncontrolled air infiltration;  |
| Corrin/Coolcarron fringes)    | cut-timber roof pitches          | oversized standard oil boilers. |
+-------------------------------+----------------------------------+---------------------------------+
```
...
```
   ...
   Homeowner engages EcoSmartHomes Technical Advisor
   (Carries out full DEAP survey, room dimensions, U-value audits)
                  │
                  ▼
   [ Step 2: Technical Assessment Publishing ]
   Advisor publishes Technical Assessment & Pre-Works BER to SEAI portal
   (Establishes baseline HLI and creates Part L Pathway)
                  │
                  ▼
   [ Step 3: Capital Works Completion ]
   Contractor completes fabric upgrades + Air-to-Water Heat Pump
                  │
                  ▼
...
## 3. The Roadmap to an A2 BER & NZEB Part L Compliance

Transforming a typical D- or E-rated Fermoy home to an A2 rating requires a systematic, fabric-first approach adhering to Irish Code of Practice **S.R. 54:2014+A1:2022** and **Building Regulations TGD Part L**.

```
+-----------------------------------------------------------------------------------------------+
|                       FABRIC-FIRST RETROFIT SEQUENCE (TGD PART L COMPLIANT)                    |
|                                                                                               |
|  [1. Thermal Envelope]  ──>  [2. Controlled Airflow]  ──>  [3. Heat Source]  ──> [4. Micro-Gen]|
|   • Roof: 300mm Quilt         • Target: <3.0 ACH@50Pa       • Heat Pump (COP >3.5) • Solar PV |
|   • Walls: Target U ≤ 0.18    • Demand Controlled (DCV)    • Weather Compensation • Diverter  |
|   • Glazing: U ≤ 1.2 W/m²K      or Heat Recovery (MVHR)    • Low-Temp Radiators               |
+-----------------------------------------------------------------------------------------------+
```
...
4. Record radiator surface areas, primary pipework diameters, hot water cylinder capacity, and heating control zones.
...
<div class="ecosmart-grant-calculator my-8 p-6 bg-slate-900 text-white rounded-xl border border-emerald-500/30 shadow-2xl" data-location="Fermoy">
  <div class="flex items-center justify-between mb-4 border-b border-slate-800 pb-3">
    <div>
      <h3 class="text-xl font-bold text-emerald-400">SEAI Grant & Co-Funding Calculator (Fermoy)</h3>
...
<div class="ecosmart-stripe-bridge my-8 p-6 bg-gradient-to-br from-slate-900 via-indigo-950/40 to-slate-900 border-2 border-indigo-500/40 rounded-xl text-white shadow-2xl" data-keyword="seai technical advisor fee repayment Fermoy">
  <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
    <div>
      ...
      <h3 class="text-xl font-bold text-white">Book Your Fermoy Home Architectural & Technical Survey</h3>
