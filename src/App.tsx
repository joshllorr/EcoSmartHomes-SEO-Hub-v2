...
export default function App() {
  const routeToTab: Record<string, string> = {
    ...
    '#/post-install': 'p31_postinstall',
    '/blueprint-pdf': 'p29_pdf',
    '#/blueprint-pdf': 'p29_pdf',
    '/grant-submissions': 'p30_submissions',
    '#/grant-submissions': 'p30_submissions',
    '/contractor-scores': 'p33_contractor_scores',
    '#/contractor-scores': 'p33_contractor_scores',
    '/contractor-insights': 'p33_contractor_insights',
    '#/contractor-insights': 'p33_contractor_insights',
    '/home-upgrades': 'p34_upgrades',
    '#/home-upgrades': 'p34_upgrades',
    '/advisor-monitoring': 'p37_advisor',
    '#/advisor-monitoring': 'p37_advisor',
    '/sentiment-intelligence': 'p38_sentiment',
    '#/sentiment-intelligence': 'p38_sentiment',
    '/orchestrator': 'p40_orchestrator',
    '#/orchestrator': 'p40_orchestrator',
