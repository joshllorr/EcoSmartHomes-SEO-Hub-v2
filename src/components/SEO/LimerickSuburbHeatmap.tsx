...
export const SUBURB_METRICS: Record<string, SuburbData> = {
  'Limerick City': {
    ...
    competition: 82,
    berDemandScore: 94,
    topQuery: 'BER Assessment Limerick City',
    zoneCode: 'V94-01',
  },
  Castletroy: {
    name: 'Castletroy',
    ...
    competition: 74,
    berDemandScore: 91,
    topQuery: 'Heat Pump Retrofit Castletroy',
    zoneCode: 'V94-02',
  },
  Raheen: {
    name: 'Raheen',
    ...
    competition: 68,
    berDemandScore: 88,
    topQuery: 'SEAI Grant Contractor Raheen',
    zoneCode: 'V94-03',
  },
  Dooradoyle: {
    name: 'Dooradoyle',
    ...
    competition: 65,
    berDemandScore: 86,
    topQuery: 'Solar PV Installation Dooradoyle',
    zoneCode: 'V94-04',
  },
  Annacotty: {
    name: 'Annacotty',
    ...
    competition: 58,
    berDemandScore: 80,
    topQuery: 'Attic Insulation Annacotty',
    zoneCode: 'V94-05',
  },
  Mungret: {
    name: 'Mungret',
    ...
    competition: 52,
    berDemandScore: 78,
    topQuery: 'Home Energy Audit Mungret',
    zoneCode: 'V94-06',
  },
  'V94 Eircode Area': {
    name: 'V94 Eircode Area',
    searchVolume: 16100,
    competition: 79,
    berDemandScore: 92,
    topQuery: 'V94 Energy Upgrade Contractors',
    zoneCode: 'V94-ALL',
  },
  Adare: {
    name: 'Adare',
    ...
    competition: 45,
    berDemandScore: 73,
    topQuery: 'Historic Home Retrofit Adare',
    zoneCode: 'V94-07',
  },
  Monaleen: {
    name: 'Monaleen',
    ...
    competition: 50,
    berDemandScore: 82,
    topQuery: 'A-Rated Extension Monaleen',
    zoneCode: 'V94-08',
  },
  Corbally: {
    name: 'Corbally',
    ...
    competition: 48,
    berDemandScore: 75,
    topQuery: 'Wall Insulation Corbally',
    zoneCode: 'V94-09',
  },
  Caherdavin: {
    name: 'Caherdavin',
    ...
    competition: 51,
    berDemandScore: 77,
    topQuery: 'Heat Pump Installer Caherdavin',
    zoneCode: 'V94-10',
  },
  Rhebogue: {
    name: 'Rhebogue',
    ...
    competition: 38,
    berDemandScore: 68,
    topQuery: 'SEAI One Stop Shop Rhebogue',
    zoneCode: 'V94-11',
  },
  Castleconnell: {
    name: 'Castleconnell',
    ...
    competition: 41,
    berDemandScore: 70,
    topQuery: 'BER Certificate Castleconnell',
    zoneCode: 'V94-12',
  },
  Shannon: {
    name: 'Shannon',
    ...
    competition: 62,
    berDemandScore: 84,
    topQuery: 'Commercial BER Shannon',
    zoneCode: 'V14-SH',
  },
  Patrickswell: {
    name: 'Patrickswell',
    ...
    competition: 31,
    berDemandScore: 62,
    topQuery: 'Grants Retrofit Patrickswell',
    zoneCode: 'V94-13',
  },
  Ballyneety: {
    name: 'Ballyneety',
    ...
    competition: 28,
    berDemandScore: 59,
    topQuery: 'Solar Panels Ballyneety',
    zoneCode: 'V94-14',
  },
  Clarina: {
    name: 'Clarina',
    ...
    competition: 25,
    berDemandScore: 55,
    topQuery: 'Draft Proofing Clarina',
    zoneCode: 'V94-15',
  },
};
...
export const LimerickSuburbHeatmap: React.FC<LimerickSuburbHeatmapProps> = ({
  ...
  const [metricMode, setMetricMode] = useState<
    'searchVolume' | 'competition' | 'berDemandScore'
  >('searchVolume');
  ...
  useEffect(() => {
    if (!svgRef.current || !containerRef.current || suburbsData.length === 0)
      return;
    ...
    if (metricMode === 'searchVolume') {
      ...
      colorScale = d3
        ...
        .interpolator(
          d3.interpolateRgb('rgba(6, 78, 59, 0.8)', 'rgba(52, 211, 153, 0.95)'),
        );
    ...
    cellGroup
      ...
      .attr('stroke', (d: any) =>
        selectedSuburbs.includes(d.data.name)
          ? '#34d399'
          : 'rgba(255, 255, 255, 0.15)',
      )
      .attr('stroke-width', (d: any) =>
        selectedSuburbs.includes(d.data.name) ? 2.5 : 1,
      )
      .attr('opacity', (d: any) =>
        selectedSuburbs.includes(d.data.name) ? 1 : 0.65,
      )
    ...
    cellGroup
      ...
      .text((d: any) => {
        ...
        if (w < 70)
          return d.data.name.slice(0, 7) + (d.data.name.length > 7 ? '..' : '');
        return d.data.name;
      });
    ...
    cellGroup
      ...
      .text((d: any) => {
        ...
        if (w < 50 || h < 32) return '';
        if (metricMode === 'searchVolume')
          return `${(d.data.searchVolume / 1000).toFixed(1)}k/mo`;
  ...
  return (
    <div className="bg-slate-900/90 border border-emerald-500/30 rounded-xl p-3.5 space-y-3 font-mono text-left">
      ...
      <div
        ref={containerRef}
        className="relative w-full overflow-hidden rounded-lg bg-black/50 p-1 border border-white/10"
      >
          ...
          <div className="flex items-center gap-3 text-[11px] font-mono">
            <span>
              ...
              <strong className="text-emerald-300">
                {hoveredSuburb.searchVolume.toLocaleString()}/mo
              </strong>
            </span>
            <span>
              SEO Difficulty:{' '}
              <strong className="text-amber-300">
                {hoveredSuburb.competition}%
              </strong>
            </span>
            <span>
              BER Intent:{' '}
              <strong className="text-blue-300">
                {hoveredSuburb.berDemandScore}/100
              </strong>
            </span>
          </div>
        </div>
