...
export default function KeywordResearchTab({
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      console.error(err);
      setWarningMsg(
        'Could not fetch research results. Showing high-fidelity backup simulation.',
      );
      ...
      setResults([
        {
          ...
          cluster: 'BER Ratings & Grants',
        },
        {
          keyword: `${keyword} assessor Raheen`,
          volume: 680,
          difficulty: 18,
          relevance: 'Very High',
          intent: 'Commercial',
          cluster: 'Local Assessment',
        },
        {
          ...
          cluster: 'Heat Pump Retrofits',
        },
        {
          keyword: `SEAI insulation grants Castletroy V94`,
          volume: 390,
          difficulty: 19,
          relevance: 'High',
          intent: 'Commercial',
          cluster: 'Insulation & Grants',
        },
        {
          keyword: `home retrofit cost Limerick city`,
          volume: 310,
          difficulty: 35,
          relevance: 'High',
          intent: 'Transactional',
  ...
  const handleRunAgenticDiscovery = async () => {
    ...
    setResults([
      {
        keyword: 'SEAI Heat Pump Grant Eligibility V94',
        volume: 2200,
        difficulty: 24,
        relevance: '100% Match',
        intent: 'Commercial',
        cluster: 'Heat Pumps & SEAI Subsidies',
      },
      {
        keyword: 'Limerick Attic Insulation Cost 2026',
        volume: 1850,
        difficulty: 19,
        relevance: '98% Match',
        intent: 'Transactional',
        cluster: 'Attic & Wall Insulation',
      },
      {
        keyword: 'BER Assessor Raheen & Castletroy Turnaround',
        volume: 1300,
        difficulty: 15,
        relevance: '96% Match',
        intent: 'Transactional',
        cluster: 'Local BER Certification',
      },
      {
        keyword: 'One-Stop-Shop Retrofit vs Individual SEAI Grants',
        volume: 950,
        difficulty: 21,
        relevance: '95% Match',
        intent: 'Informational',
        cluster: 'Retrofit Strategy',
      },
      {
        keyword: 'Solar PV Panel Payback Period Munster',
        volume: 820,
        difficulty: 29,
        relevance: '92% Match',
        intent: 'Commercial',
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-400 text-xs mt-1">
            Perform semantic search engine analyses to identify keywords with
            maximum organic traffic potential in Ireland.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
          <div className="bg-black/40 border border-white/10 hover:border-emerald-500/40 rounded-xl p-3.5 space-y-1.5 transition">
            ...
            <p className="text-[11px] text-slate-300 leading-relaxed">
              Goes beyond basic volume metrics to analyze your site&apos;s
          ...
          <div className="bg-black/40 border border-white/10 hover:border-emerald-500/40 rounded-xl p-3.5 space-y-1.5 transition">
            ...
            <h4 className="text-xs font-bold text-white">
              Cannibalization Shield
            </h4>
            <p className="text-[11px] text-slate-300 leading-relaxed">
              Cross-references with current blog content to prevent duplicate
              cannibalization.
            </p>
          </div>
          ...
          <div className="bg-black/40 border border-white/10 hover:border-emerald-500/40 rounded-xl p-3.5 space-y-1.5 transition">
            ...
            <p className="text-[11px] text-slate-300 leading-relaxed">
              Automatically analyzes competitor sitemaps to find untapped
              semantic gaps.
            </p>
          </div>
          ...
          <div className="bg-black/40 border border-white/10 hover:border-emerald-500/40 rounded-xl p-3.5 space-y-1.5 transition">
            ...
            <h4 className="text-xs font-bold text-white">
              Topical Clustering (8 Min)
            </h4>
            <p className="text-[11px] text-slate-300 leading-relaxed">
              Builds high-authority topical clusters contextually within 8
              minutes.
            </p>
          </div>
        </div>
            ...
            <div className="p-4 grid grid-cols-1 md:grid-cols-3 gap-4 border-t border-white/10 text-xs font-mono">
              ...
              <div className="bg-black/60 border border-white/10 rounded-lg p-3 space-y-1.5">
                ...
                <p className="text-[10px] text-slate-400 font-sans leading-normal">
                  Scrapes competitor XML sitemaps and evaluates DOM hierarchy
                  for authority gaps.
                </p>
              </div>
              ...
              <div className="bg-black/60 border border-white/10 rounded-lg p-3 space-y-1.5">
                ...
                <p className="text-[10px] text-slate-400 font-sans leading-normal">
                  Guarantees structured JSON outputs matching exact topic
                  cluster schemas.
                </p>
              </div>
              ...
              <div className="bg-black/60 border border-white/10 rounded-lg p-3 space-y-1.5">
                ...
                <p className="text-[10px] text-slate-400 font-sans leading-normal">
                  Broad semantic sampling pruned down to 50 optimal
                  low-difficulty clusters.
                </p>
              </div>
            </div>
          )}
        ...
        {agentLogs.length > 0 && (
          <div className="bg-black/80 border border-emerald-500/30 rounded-xl p-3.5 font-mono text-[11px] text-emerald-300 space-y-1 animate-in fade-in duration-300">
            <div className="flex items-center justify-between border-b border-white/10 pb-2 mb-2 text-[10px] text-slate-400">
              ...
              <span>
                {agentRunning ? 'Processing...' : 'Status: Completed'}
              </span>
            </div>
      ...
      {results.length > 0 ? (
        <div className="glass-card overflow-hidden animate-in fade-in duration-300">
          <div className="px-5 py-4 bg-white/5 border-b border-white/10 flex justify-between items-center">
            <span className="text-xs font-bold text-slate-200">
              Keyword Analytics Results for{' '}
              <em className="text-[#34d399] italic">“{keyword}”</em>
            </span>
              ...
              <tbody className="divide-y divide-white/10">
                {results.map((res, idx) => (
                  <tr key={idx} className="hover:bg-white/5 transition">
                    ...
                    <td className="p-4">
                      <span
                        className={`px-2 py-0.5 rounded-md text-[10px] font-mono font-bold border ${getDifficultyColor(res.difficulty)}`}
                      >
                        {res.difficulty}/100
                      </span>
                    </td>
        ...
        <div className="bg-white/5 border-2 border-dashed border-white/10 rounded-2xl p-8 text-center flex flex-col items-center justify-center min-h-[220px]">
          ...
          <p className="text-xs text-slate-400 max-w-sm mt-1 leading-normal">
            Analyze what energy retrofitting terms Irish homeowners search for
            (e.g. <em>&quot;BER A rating timeline&quot;</em>,{' '}
            <em>&quot;SEAI subsidies&quot;</em>).
          </p>
        </div>
      )}
    </div>
