...
export default function FleetManager() {
  ...
  const [autonomyModes, setAutonomyModes] = useState<
  ...
  const handleGlobalOptimization = () => {
    ...
    alert(
      `Triggered global optimization pipeline for ${domains.length} domains.`,
    );
  };
    ...
    <div style={{ padding: '24px', color: '#f8fafc' }}>
      ...
      >
        <div>
          ...
          >
            Multi-Domain Fleet Manager
          </h2>
          <p style={{ color: '#94a3b8', margin: 0, fontSize: '14px' }}>
            Configure Per-Domain Autonomy Modes (Passive, Assisted, Full
            Autonomous) & orchestrate SEO engines across properties.
          </p>
        </div>
        <button
      ...
      >
        ...
        >
          <thead>
            ...
            >
              <th
                style={{ padding: '16px', color: '#94a3b8', fontWeight: 600 }}
              >
                Domain
              </th>
              <th
          ...
          <tbody>
            {fleetData &&
              Object.entries(fleetData).map(([domain, metrics]) => {
                  ...
                  >
                    ...
                    <td style={{ padding: '16px' }}>
                      <select
                        ...
                        onChange={(e) =>
                          handleModeChange(
                            domain,
                            e.target.value as AutonomyMode,
                          )
                        }
                        style={{
                          background:
                            currentMode === 'full_autonomous'
                              ? 'rgba(16, 185, 129, 0.2)'
                      ...
                      >
                        ...
                        >
                          1. Passive (Suggestions Only)
                        </option>
                        <option
                          value="assisted"
                          style={{ background: '#0f172a', color: '#f8fafc' }}
                        >
                          2. Assisted (Waits Approval)
                        </option>
                        <option
                          value="full_autonomous"
                          style={{ background: '#0f172a', color: '#f8fafc' }}
                        >
                          3. Full Autonomous (Auto-Executes)
                        </option>
                      </select>
                    </td>
                    ...
                    <td style={{ padding: '16px' }}>
                      <span
                        style={{
                          ...
                          gap: '6px',
                          color:
                            metrics.status === 'online' ? '#10b981' : '#ef4444',
                          background:
                    ...
                    <td style={{ padding: '16px' }}>
                      <div style={{ display: 'flex', gap: '8px' }}>
                        <button
                          onClick={() =>
                            hubCommands.generateDraft('auto-fleet', {
                              siteId: domain,
                            })
                          }
                        ...
                        <button
                          onClick={() =>
                            hubCommands.rewriteArticle('auto-fleet', {
                              siteId: domain,
                            })
                          }
                          style={actionBtnStyle}
                        ...
                        <button
                          onClick={() =>
                            hubCommands.queueExpansion('auto-fleet', {
                              siteId: domain,
                            })
                          }
                          style={actionBtnStyle}
                        ...
                        <button
                          onClick={() =>
                            hubCommands.publishToGitHub('auto-fleet', {
                              siteId: domain,
                            })
                          }
                          style={actionBtnStyle}
