...
export default function Writer() {
  ...
  return (
    <div className="p-6 space-y-6 text-left bg-white rounded-xl shadow-lg border border-slate-200" id="writer-component">
      <h1 className="text-2xl font-bold text-slate-900 tracking-tight">Content Writer & Editor</h1>
