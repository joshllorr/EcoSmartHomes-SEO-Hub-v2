  ...
  const handleAskSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setQaResult({
        ...
        sources: [
          'seai-grants-guide.html',
          'heat-pump-costs.html',
          'ber-certificate.html',
        ],
      });
    } finally {
      setQaLoading(false);
  ...
  return (
    ...
    >
      ...
      <p style={{ margin: '0 0 20px 0', color: '#94a3b8', fontSize: '14px' }}>
        Conversational Q&amp;A powered by your knowledge corpus — SEAI, CRU,
        NSAI datasets and semantic entity graphs.
      </p>
