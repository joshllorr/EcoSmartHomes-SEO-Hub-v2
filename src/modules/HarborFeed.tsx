...
export default function HarborFeed() {
  ...
  const filterTypes = [
    "", "draft_created", "rewrite_success", "scheduled_publish",
    "autonomous_expansion", "expansion_queued", "serp_diff",
    "link_bait_generated", "visibility_spike", "semantic_enrichment",
    "multi_site_expansion", "conversational_knowledge"
  ];
          ...
          {events.map(e => (
            ...
            >
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                {e.slug && (
                  <code style={{ marginTop: "3px", display: "inline-block", fontSize: "11px", color: "#38bdf8" }}>
                    {e.slug}.html
                  </code>
                )}
              </div>
