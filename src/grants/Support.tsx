      ...
      <div className="p-5 bg-purple-500/10 border border-purple-500/20 rounded-xl flex items-start gap-4">
        ...
        <div>
          <h3 className="text-base font-bold text-white">
            Free SEAI Registered Advisor Consultation
          </h3>
          <p className="text-xs text-slate-300 mt-1 font-mono">
            Connect with a local registered Irish building energy surveyor to
            review your property Grant Plan (ID:{' '}
            <strong className="text-purple-300">{grantId}</strong>) for Eircode
            region{' '}
            <strong className="text-purple-300">{eircode.slice(0, 3)}</strong>.
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 font-mono text-xs">
        <div className="p-4 bg-slate-950/80 border border-white/10 rounded-xl flex flex-col gap-2">
          ...
          <p className="text-slate-400 text-[11px]">
            No pressure — just friendly, professional guidance on SEAI grant
            paperwork and contractor installation quotes.
          </p>
        </div>
        ...
        <div className="p-4 bg-slate-950/80 border border-white/10 rounded-xl flex flex-col gap-2">
          ...
          <p className="text-slate-400 text-[11px]">
            Your advisor John O&apos;Donnell is registered with SEAI Ireland for
            grant sign-offs and BER assessments.
          </p>
        </div>
      </div>
        ...
        <div>
          ...
          <div className="text-[11px] text-slate-400 font-mono mt-0.5 flex flex-wrap gap-3">
            <span className="flex items-center gap-1">
              <PhoneCall size={12} className="text-purple-400" /> 085-123-4567
            </span>
            <span className="flex items-center gap-1">
              <Mail size={12} className="text-purple-400" /> advisor@ecosmart.ie
            </span>
          </div>
        </div>
