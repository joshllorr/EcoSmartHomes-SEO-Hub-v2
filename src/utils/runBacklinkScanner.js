/**
 * Gemini Backlink Scanner API Wrapper
 * Scans for high-value backlink opportunities tailored to link bait ideas in Limerick & surrounding areas
 */
export async function runBacklinkScanner(linkBaitIdeas = [], apiKey = "") {
...
`
  ...
  try {
    // Primary: Express server API proxy
    ...
    // Direct Gemini API Fallback if custom key provided
...
export const fallbackBacklinkOpportunities = [
  {
