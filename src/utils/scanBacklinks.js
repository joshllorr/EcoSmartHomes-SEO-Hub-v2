/**
 * Backlink Scanner AI Utility
 * Identifies real backlink opportunities for ecosmarthomes.ie across Irish & Limerick publications
 */
export async function scanBacklinks(site = "ecosmarthomes.ie", apiKey = "") {
