/**
 * Harbor-Style "Build This Page" AI Generator Utility
 * Generates full Link Bait Page HTML & JSON metadata for an Irish retrofit asset
 */
export async function buildLinkBaitPage(idea, apiKey = "") {
...
`
  ...
  try {
    // Primary: Express backend API proxy
