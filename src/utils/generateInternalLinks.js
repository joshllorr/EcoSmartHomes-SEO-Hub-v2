/**
 * Internal Linking AI Utility
 * Generates hub -> spoke internal linking recommendations across pillar pages, link bait, location pages, and writer drafts.
 */
export async function generateInternalLinks(inputPayload = {}, apiKey = "") {
...
export const fallbackInternalLinks = [
  {
