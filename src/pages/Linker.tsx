...
import LinkerIdeasGrid, {
  PillarPageItem,
  LinkOpportunityItem,
  LinkBaitAssetItem,
} from '../components/Linker/LinkerIdeasGrid';
...
export default function Linker() {
  ...
  const activeTab: LinkerTabType =
    location.pathname === '/pillar-pages'
      ? 'pillar_pages'
  ...
  const [websiteUrl, setWebsiteUrl] = useState(
    `https://${targetDomain || 'ecosmarthomes.ie'}/`,
  );
