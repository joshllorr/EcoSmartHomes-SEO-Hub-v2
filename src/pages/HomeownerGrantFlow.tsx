...
export default function HomeownerGrantFlow() {
      ...
      setPlan({
        ...
        eligibleGrants: [
          ...
          },
          {
            ...
            amount: 2100,
            description: 'SEAI zero-emissions rooftop solar electricity grant.',
          },
          {
  ...
  const totalGrantValue = (plan?.eligibleGrants || []).reduce(
    (sum: number, g: any) => sum + g.amount,
    0,
  );
      ...
      <div className="w-full max-w-3xl glass-card p-6 md:p-8 border border-white/10 rounded-2xl bg-slate-900/80 shadow-2xl relative">
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-[11px] text-slate-400 font-mono">
                SEAI Grant Eligibility & BER Energy Plan 2026
              </p>
            </div>
          </div>
            ...
            <div className="flex items-center gap-3 bg-emerald-500/10 border border-emerald-500/20 p-4 rounded-xl">
              ...
              <div>
                <h2 className="text-sm font-bold text-white">
                  Check Your 2026 SEAI Home Energy Grant Funding
                </h2>
                <p className="text-xs text-slate-300 mt-0.5">
                  Irish homeowners can access up to{' '}
                  <strong className="text-emerald-300">€14,200</strong> in
                  government grants for heat pumps, wall insulation, and solar
                  panels.
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3 text-xs font-mono">
              <div className="p-3 bg-slate-950/60 border border-white/5 rounded-xl">
                ...
                <p className="text-slate-400 text-[11px] mt-1">
                  Eircode & BER envelope validation.
                </p>
              </div>
              <div className="p-3 bg-slate-950/60 border border-white/5 rounded-xl">
                ...
                <p className="text-slate-400 text-[11px] mt-1">
                  Instant SEAI funding breakdown.
                </p>
              </div>
              <div className="p-3 bg-slate-950/60 border border-white/5 rounded-xl">
        ...
        {step === 'setup' && (
          <div className="flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-4 text-xs font-mono">
              <div className="flex flex-col gap-1.5">
                ...
                >
                  ...
                  <option value="Electric">
                    Direct Electric Storage Heaters
                  </option>
              ...
              <div className="flex flex-col gap-1.5">
                <label className="text-slate-300 font-bold">
                  Existing Insulation Upgrades Installed
                </label>
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="flex justify-between items-center mt-4">
              ...
              >
                ...
                <span>
                  {loading ? 'Calculating...' : 'Calculate My SEAI Grants'}
                </span>
              </button>
            </div>
          </div>
        ...
        {step === 'results' && plan && (
          <div className="flex flex-col gap-5">
            <div className="p-4 bg-emerald-500/10 border border-emerald-500/20 rounded-xl flex justify-between items-center">
              <div>
                <span className="text-[10px] font-mono text-emerald-400 font-bold uppercase">
                  Estimated Total SEAI Grant Value
                </span>
                <h3 className="text-2xl font-extrabold font-mono text-white mt-0.5">
            ...
            <h3 className="text-xs font-bold text-white font-mono uppercase border-b border-white/10 pb-2">
              Your Eligible Grants Breakdown
            </h3>
            <div className="flex flex-col gap-2.5 text-xs font-mono">
              {(plan.eligibleGrants || []).map((g: any, idx: number) => (
                <div
                  key={idx}
                  className="p-3 bg-slate-950/80 border border-white/5 rounded-xl flex justify-between items-center"
                >
                  <div>
            ...
            <div className="p-4 bg-slate-950/80 border border-indigo-500/30 rounded-xl flex flex-col gap-2 font-mono text-xs">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-2 mt-1">
                ...
                ).map((stepName: string, idx: number) => (
                  <div
                    key={idx}
                    className="p-2.5 bg-slate-900 border border-white/10 rounded-lg flex flex-col justify-between"
                  >
                    <span className="text-[10px] text-slate-400">
                      Step {idx + 1}
                    </span>
                    <span className="font-bold text-slate-200 mt-1">
                      {stepName}
                    </span>
                  </div>
                ))}
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 font-mono text-xs">
              <div className="p-4 bg-slate-950/80 border border-white/10 rounded-xl flex flex-col justify-between">
                ...
                <span className="text-2xl font-bold text-rose-400 mt-2">
                  {plan.currentBER}
                </span>
              </div>
            ...
            <div className="p-4 bg-slate-950/80 border border-white/10 rounded-xl flex justify-between items-center font-mono text-xs">
              <div>
                <span className="text-slate-400">
                  Estimated Annual Energy Bill Reduction:
                </span>
                <h4 className="text-xl font-bold text-emerald-300 mt-1">
                  €{plan.savingsEstimate} / year
                </h4>
              </div>
          ...
          <div className="flex flex-col items-center justify-center gap-5 text-center py-6">
            ...
            <div>
              <h2 className="text-xl font-bold text-white">
                Your Grant Plan Is Locked!
              </h2>
              <p className="text-xs text-slate-400 font-mono mt-1">
                Plan ID: <strong className="text-emerald-300">{plan.id}</strong>
              </p>
            </div>

            <div className="p-4 bg-slate-950/80 border border-white/10 rounded-xl text-xs font-mono text-slate-300 max-w-md">
              We have generated your customized SEAI grant roadmap (€
              {totalGrantValue.toLocaleString()} funding) and notified your
              regional registered SEAI advisor in {eircode.slice(0, 3)}.
            </div>
